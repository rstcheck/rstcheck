...
- Add note for incompatiblity of typer <0.4.1 and click >=8.1 ([#136](https://github.com/rstcheck/rstcheck/issue/138))
...
- Bump lower version constraint on typer from 0.3.2 to 0.4.1 ([#136](https://github.com/rstcheck/rstcheck/issue/138))
